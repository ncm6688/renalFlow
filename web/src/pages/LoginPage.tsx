          ...
          <div className="mb-6">
            <div className="flex items-center gap-3">
              <svg width="34" height="34" viewBox="0 0 44 44" aria-hidden="true" className="shrink-0">
                ...
                <rect x="2" y="2" width="40" height="40" rx="14" fill="url(#sage)" stroke="#E2E8F0" />
                <path d="M16 23c4-10 16-10 12 2-2 6-8 10-12 8" fill="none" stroke="#5E8F76" strokeWidth="2.2" strokeLinecap="round" />
              </svg>
              <div>
                <div className="text-sm font-semibold text-[#5E8F76]">RenalFlow</div>
                <div className="mt-0.5 text-2xl font-semibold tracking-tight text-slate-900">Welcome back</div>
              </div>
            </div>
            <div className="mt-1 text-sm text-slate-600">
              Sign in to track kidney health metrics and join the community.
            </div>
          </div>
            ...
            <CardBody>
              ...
              >
                ...
                <div className="text-center text-sm text-slate-600">
                  New here? <SubtleLink to="/register">Create an account</SubtleLink>
                </div>
              </form>
            </CardBody>
          </Card>
